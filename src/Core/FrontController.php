    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            ...
            if ($this->container instanceof \DI\Container) {
                ...
                // Fallback: instantiate manually if not PHP-DI
                $controllerObject = new $controllerClass($routeParams);
            }
...
//'#^account\/(?P<controller>[a-zA-Z]+)$#i'
        ...
        // $this->router->add('store/post/{action}', [
        //     'namespace' => 'Account\\Store',
        //     'controller' => 'Post'
        // ]);
        // $this->router->add('store/post', [
        //     'namespace' => 'Account\\Store',
        //     'controller' => 'Post',
        //     'action' => 'index'
        // ]);

        // // Explicit route for Store controller
        // $this->router->add('store', [
        //     'namespace' => 'Account',
        //     'controller' => 'Store',
        //     'action' => 'index'
        // ]);

        // // Explicit route for Store controller with actions
        // $this->router->add('store/{action}', [
        //     'namespace' => 'Account',
        //     'controller' => 'Store'
        // ]);


        // $this->router->add('store/{controller}/{action}', ['namespace' => 'Store']);
        // $this->router->add('store/{controller}', ['namespace' => 'Store', 'action' => 'index']);

        // $this->router->add('store', [
        //     'controller' => 'Store',
        //     'action' => 'index',
        //     'namespace' => 'App\\Features\\Account\\Store\\Dashboard'
        // ]);
        // $this->router->add('account/store', [
        //     'namespace' => 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\\Store\\Dashboard',
        //     'controller' => 'xxxxxxxxxxxxxxxxxxxxxxxxxxx',
        //     'action' => 'index'
        // ]);
        // $this->router->add('store/dashboard', [
        //     // 'namespace' => 'Account\\Store\\StoreDashboard',
        ...
        // $this->router->add('admin/{controller}', [
        //     'namespace' => 'Account\\Store', // Important: Use Store namespace
        //     'action' => 'index'
        // ]);
        // // admin Albums Edit
        ...
        //     'action' => 'index'
        // ]);
        // ## http://mvclixo.tv/store/dashboard
        // $this->router->add('store/albums', [
        //     'namespace' => 'Store',
        //     'controller' => 'Albums',
        //     'action' => 'index'
        // ]);
        ...
        ## http://mvclixo.tv/store/profile
        $this->router->add('store/profile', [
            'namespace' => 'Store',
            'controller' => 'Profile',
            'action' => 'index',
            'route_id' => 'bee310-store-hc/hc/hc', // ok
        ]);
        ## http://mvclixo.tv/store/settings
        $this->router->add('store/settings', [
            'namespace' => 'Store',
            'controller' => 'Settings',
            'action' => 'index',
        ...
        ## http://mvclixo.tv/store/xxxxx
        ## http://mvclixo.tv/store/albums
        ## http://mvclixo.tv/store/post



        $this->router->add('store/{controller}', [
            // 'namespace' => NOT SET
            'action' => 'index',
            'route_id' => 'bee320-store-hc-dyn-hc',
        ]); // ok
        $this->router->add('store/{controller}/{action}', [
            // 'namespace' => NOT SET
            'route_id' => 'bee901-root-hc-dyn-dyn',
        ]);
        // Store Albums Edit
        $this->router->add('store/{controller}/{action}/{id:\d+}', [
            // 'namespace' => NOT SET
        ...
        $this->router->add('account/{controller}', [
            // 'namespace' => NOT SET
            'action' => 'index',
            'route_id' => 'bee320a-account-hc-dyn-hc',
        ]); // ok
        $this->router->add('account/{controller}/{action}', [
            // 'namespace' => NOT SET
            'route_id' => 'bee901a-root-hc-dyn-dyn',
        ]);
        // Store Albums Edit
        $this->router->add('account/{controller}/{action}/{id:\d+}', [
            // 'namespace' => NOT SET
            'route_id' => 'bee903a-root-hc-dyn-dyn',
        ]);
        ...
        // $this->router->add('store/{controller}', ['namespace' => 'Account\\Store', 'action' => 'index']);
        // $this->router->add('store/{controller}/{action}', ['namespace' => 'Account\\Store']);


        // Albums
        //.. $this->router->add('store/{controller}', ['action' => 'index']);
        //.. $this->router->add('store/{controller}/{action}');
        // Albums Edit
        //.. $this->router->add('store/{controller}/{action}/{id:\d+}');
        ...
        // $this->router->add('store/{controller}/{action}/{id:\d+}', ['namespace' => 'Account\\Store']);
