...
use Core\Database\Seeders\TableSeeder;
use Core\Database\Seeders\SeederInterface;
...
abstract class Seeder implements SeederInterface
{
     ...
     * @param array<string, mixed> $conditions Optional WHERE conditions as column => value pairs
     ...
     * @param array<int, string> $uniqueCheck Fields to check for uniqueness
