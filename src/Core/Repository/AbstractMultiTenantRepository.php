 ...
 */
abstract class AbstractMultiTenantRepository extends AbstractRepository
{
    ...
    /**
     * Find entities by user ID with specified fields (raw data).
     *
     * @param int $userId
    ...
    /**
     * Find entities by store ID with specified fields (raw data).
     *
     * @param int $storeId
     * @param array<string> $fields
     * @param array<string, string> $orderBy
     ...
     * @return array<array<string, mixed>>
     */
    public function findByStoreIdWithFields( // xxx
        int $storeId,
        array $fields,
        array $orderBy = [],
        ?int $limit = null,
    ...
    /**
     * Count entities by store ID.
     *
     * @param int $storeId
     * @return int
     */
    public function countByStoreId(int $storeId): int  // xxx
    {
