...
/**
 * Registry for list renderers
 *
 * This class manages the available renderers for list generation.
 * Each renderer is responsible for generating HTML markup according
 * to a specific CSS framework (Bootstrap, Tailwind, etc.)
 */
class ListRendererRegistry
{
    /**
     * Registered renderers
     *
     * @var array<string, ListRendererInterface>
     */
     ...
     * @return self
     */
    public function register(string $name, ListRendererInterface $renderer): self
    {
     ...
     */
    public function getRenderer(?string $name = null): ListRendererInterface
    {
     ...
     *
     * @return array<string, ListRendererInterface>
     */
