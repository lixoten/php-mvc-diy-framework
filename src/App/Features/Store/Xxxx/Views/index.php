<?php
// filepath: d:\xampp\htdocs\my_projects\mvclixo\src\App\Features\Store\Profile\Views\index.php
...
$configSections = $data['configSections'] ?? [
    [
        ...
        'icon' => 'fa-store',
        'url' => BASE_URL . '/account/store/profile/edit',
        'badge' => null
    ],
    [
        'title' => 'Branding',
        ...
        'icon' => 'fa-paint-brush',
        'url' => BASE_URL . '/account/store/profile/branding',
        'badge' => null
    ],
    [
        ...
        'icon' => 'fa-credit-card',
        'url' => BASE_URL . '/account/store/profile/payments',
        'badge' => null
    ],
    [
        ...
        'icon' => 'fa-truck',
        'url' => BASE_URL . '/account/store/profile/shipping',
        'badge' => null
    ],
    [
        ...
        'url' => BASE_URL . '/account/storeprofile/policies',
        'badge' => null
    ],
    [
        ...
        'icon' => 'fa-users',
        'url' => BASE_URL . '/account/storeprofile/team',
    ...
    [
        ...
        'icon' => 'fa-share-alt',
        'url' => BASE_URL . '/account/storerofile/social',
        'badge' => null
    ],
    [
        'title' => 'Notifications',
        ...
        'icon' => 'fa-bell',
        'url' => BASE_URL . '/account/storeprofile/notifications',
        'badge' => null
    ],
];
?>
...
<div class="profile-header">
    ...
    <div class="actions">
        ...
        <a href="<?= BASE_URL ?>/account/store/profile/edit" class="btn btn-primary">
                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="checklist">
                            ...
                            <li class="incomplete">
                                ...
                                <a href="<?= BASE_URL ?>/account/store/profile/payments" class="ms-2">Configure</a>
                            </li>
                            <li class="incomplete">
                                <i class="fas fa-exclamation-circle text-warning"></i>
                                <span>Shipping options not set up</span>
                                <a href="<?= BASE_URL ?>/account/store/profile/shipping" class="ms-2">Configure</a>
                            </li>
                            <li class="incomplete">
                                <i class="fas fa-exclamation-circle text-warning"></i>
                                <span>Store policies missing</span>
                                <a href="<?= BASE_URL ?>/account/store/profile/policies" class="ms-2">Configure</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4">
