...
$storeName = $store ? $store->getName() : 'Your Store ccc';
...
$configSections = $data['configSections'] ?? [
    ...
    [
        ...
        'url' => BASE_URL . 'account/store/profile/policies',
        'badge' => null
    ],
    [
    ...
    [
        ...
        'icon' => 'fa-share-alt',
        'url' => BASE_URL . 'account/store/profile/social',
        'badge' => null
    ],
    [
        'title' => 'Notifications',
        ...
        'icon' => 'fa-bell',
        'url' => BASE_URL . 'account/store/profile/notifications',
        'badge' => null
    ],
];
?>
