...
class PostsController extends Controller
{
    ...
    public function editAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if (!$this->isUserAuthorized($record->getPostUserId())) {
            ...
            return $this->redirect(Url::CORE_POSTS->url()); //fixme
        }
        ...
        $response = $this->view(Url::CORE_POSTS_EDIT->view(), $viewData); //fixme make generic
    ...
    public function createAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        // Create response with appropriate status code
        $response = $this->view(Url::CORE_POSTS_CREATE->view(), $viewData);
