...
namespace App\Features\Account\Mystores;

use App\Enums\FlashMessageType;
use App\Features\Account\Mystores\Form\MystoresFormType;
...
class MystoresController extends Controller
{
    ...
    private MystoresFormType $mystoresFormType;
    /**
     * Constructor
     */
    public function __construct(
        ...
        MystoresFormType $mystoresFormType,
    ) {
        parent::__construct(
            $route_params,
            $flash,
        ...
        $this->mystoresFormType = $mystoresFormType;
    }
    ...
    // {
    //     return $this->view('account/mystores/index', [
    //         'title' => 'Store'
    //     ]);
    // }
    ...
    public function indexAction(): ResponseInterface
    {
        ...
        $store = null; //$this->storeRepository->findByUserId($currentUser->getUserId());
        ...
        $recentOrders = null; //$this->orderRepository->findRecentByStoreId($store->getId(), 5);

        // Render the dashboard view
        return $this->view(MystoresConst::VIEW_MYSTORES_INDEX, [
    ...
    public function createAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($formHandled && $form->isValid()) {
            ...
            try {
                ...
                if ($storeId) {
                    ...
                    return $this->redirect('/mystoresccccccc'); // TODO fix
                } else {
        ...
        $response = $this->view(MystoresConst::VIEW_MYSTORES_CREATE, $viewData);
        ...
        // return $this->view('account/mystores/create', [
