 ...
 * Form type
 */
class MystoresFormType extends AbstractFormType
{
    use CaptchaAwareTrait;

    private MystoresFieldRegistry $fieldRegistry;
    ...
    public function __construct(
        MystoresFieldRegistry $fieldRegistry,
    ...
    {
        return 'mystores_edit_form';
    }

    /** {@inheritdoc} */
    public function buildForm(FormBuilderInterface $builder, array $options = []): void
    {
        $actionType = 'mystores_edit';
        ##############################################################################
