...
return [
    ...
    'roles' => [
        ...
        'form' => [
            ...
            'choices' => [
                'user' => 'user.roles.user---localform',
                'admin' => 'user.roles.admin---localform',
                'store_owner' => 'user.roles.store_owner---localform',
                'guest' => 'user.roles.guest---localform',
            ],
            'attributes' => [
