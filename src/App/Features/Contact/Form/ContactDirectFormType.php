 ...
 * Contact form type
 */
class ContactDirectFormType extends AbstractFormType
{
    use CaptchaAwareTrait;

    private ContactDirectFieldRegistry $fieldRegistry;
    ...
    public function __construct(
        ContactDirectFieldRegistry $fieldRegistry,
    ...
    {
        return 'contactdirect_form';
    }

    /** {@inheritdoc} */
    public function buildForm(FormBuilderInterface $builder, array $options = []): void
    {
        $actionType = 'contact_direct';
        ##############################################################################
        ...
        // $fieldNames = ['name', 'subject', 'message'];
        // $fieldNames = ['name'];
        ### Important!!! ##########################################################################
