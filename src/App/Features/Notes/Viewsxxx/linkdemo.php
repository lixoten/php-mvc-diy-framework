...
<ul>
    <li><?= LinkHelper::generateTextLink(Url::STORE_POST) ?> Text Link: Simple, uses url-enum. All defaults</li>
    <li>
...
<ul>
    ...
    <li><?= LinkHelper::generateButtonLink(Url::STORE_POST_EDIT, ['id' => 123], 'Edit Post', ['class' => 'btn btn-warning']) ?></li>
</ul>
