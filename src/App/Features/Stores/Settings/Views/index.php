<?php
// filepath: d:\xampp\htdocs\my_projects\mvclixo\src\App\Features\Stores\Settings\Views\index.php
...
$settingsCategories = [
    [
        ...
        'icon' => 'fa-credit-card',
        'url' => BASE_URL . '/stores/settings/payments',
    ...
    [
        ...
        'icon' => 'fa-truck',
        'url' => BASE_URL . '/stores/settings/shipping',
    ...
    [
        ...
        'url' => BASE_URL . '/stores/settings/tax',
    ...
    [
        ...
        'icon' => 'fa-bell',
        'url' => BASE_URL . '/stores/settings/notifications',
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="advanced-setting-item">
                            ...
                            <a href="<?= BASE_URL ?>/account/stores/settings/export" class="btn btn-sm btn-outline-secondary">Export Data</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="advanced-setting-item">
                            ...
                            <a href="<?= BASE_URL ?>/account/stores/settings/integrations" class="btn btn-sm btn-outline-secondary">Manage Integrations</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="advanced-setting-item">
                            ...
                            <a href="<?= BASE_URL ?>/account/stores/settings/security" class="btn btn-sm btn-outline-secondary">Security Settings</a>
                        </div>
                    </div>
                </div>
            </div>
