...
namespace App\Features\Stores\Settings;

use App\Enums\FlashMessageType;
use App\Enums\Url;
use App\Features\Stores\Settings\Form\SettingsFormType;
...
class SettingsController extends Controller
{
    ...
    private SettingsFormType $settingsFormType;
    /**
     * Constructor
     */
    public function __construct(
        ...
        $this->settingsFormType = $settingsFormType;
    }
    ...
    // {
    //     return $this->view('account/stores/index', [
    //         'title' => 'Store'
    //     ]);
    // }
    ...
    public function indexAction(): ResponseInterface
    {
        ...
        return $this->view(SettingsConst::VIEW_SETTINGS_INDEX, [
    ...
    public function createAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($formHandled && $form->isValid()) {
            ...
            try {
                ...
                if ($storeId) {
                    ...
                    return $this->redirect(Url::STORE_PROFILE->url()); // TODO fix?? Profile for store acceptable?
                } else {
        ...
        $response = $this->view(SettingsConst::VIEW_SETTINGS_CREATE, $viewData);
       ...
       // // Render the form view
        // return $this->view('account/stores/create', [
