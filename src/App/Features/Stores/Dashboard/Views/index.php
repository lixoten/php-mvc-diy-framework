...
<div class="row stats-cards mb-4">
    <div class="col-md-3 mb-3">
        <div class="card bg-primary text-white h-100">
            ...
            <div class="card-footer bg-transparent border-0 text-end">
                <a href="<?= BASE_URL ?>/stores/orders" class="text-white">View all <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-success text-white h-100">
            ...
            <div class="card-footer bg-transparent border-0 text-end">
                <a href="<?= BASE_URL ?>/stores/products" class="text-white">View all <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-info text-white h-100">
            ...
            <div class="card-footer bg-transparent border-0 text-end">
                <a href="<?= BASE_URL ?>/stores/posts" class="text-white">View all <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-warning text-white h-100">
            ...
            <div class="card-footer bg-transparent border-0 text-end">
                <a href="<?= BASE_URL ?>/stores/orders" class="text-white">Details <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?= BASE_URL ?>/stores/products/create" class="btn btn-primary">
                        <i class="fas fa-plus-circle"></i> Add Product
                    </a>
                    <a href="<?= BASE_URL ?>/stores/posts/create" class="btn btn-info text-white">
                        <i class="fas fa-plus-circle"></i> Add Post
                    </a>
                    <a href="<?= BASE_URL ?>/stores/orders?status=new" class="btn btn-success">
                        <i class="fas fa-clipboard-check"></i> Process Orders
                    </a>
                    <a href="<?= BASE_URL ?>/stores/albums/create" class="btn btn-secondary">
                        <i class="fas fa-images"></i> Add Album
                    </a>
                    <a href="<?= BASE_URL ?>/stores/profile/edit" class="btn btn-outline-dark">
    ...
    <div class="col-md-7 mb-4">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?= BASE_URL ?>/stores/orders" class="btn btn-sm btn-outline-primary">View All</a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="<?= BASE_URL ?>/stores/orders/view/<?= $order->getId() ?>">#<?= $order->getOrderNumber() ?></a></td>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <a href="<?= BASE_URL ?>/stores/products" class="btn btn-sm btn-outline-primary">Manage Products</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <a href="<?= BASE_URL ?>/stores/posts" class="btn btn-sm btn-outline-primary">Manage Content</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <a href="<?= BASE_URL ?>/stores/profile" class="btn btn-sm btn-outline-primary">Store Settings</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <a href="<?= BASE_URL ?>/stores/albums" class="btn btn-sm btn-outline-primary">Manage Albums</a>
                        </div>
                    </div>
