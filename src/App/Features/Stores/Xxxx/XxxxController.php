...
namespace App\Features\Stores\Xxxx;

use App\Enums\FlashMessageType;
use App\Enums\Url;
use App\Features\Stores\Xxxx\Form\XxxxFormType;
...
class XxxxController extends Controller
{
    ...
    private XxxxFormType $xxxxFormType;
    /**
     * Constructor
     */
    public function __construct(
        ...
        $this->xxxxFormType = $xxxxFormType;
    }
    ...
    public function indexAction(): ResponseInterface
    {
        ...
        return $this->view(XxxxConst::VIEW_XXXX_INDEX, [
    ...
    public function createAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($formHandled && $form->isValid()) {
            ...
            try {
                ...
                if ($storeId) {
                    ...
                    return $this->redirect(Url::STORE_PROFILE->url());
                } else {
        ...
        $response = $this->view(XxxxConst::VIEW_XXXX_CREATE, $viewData);
