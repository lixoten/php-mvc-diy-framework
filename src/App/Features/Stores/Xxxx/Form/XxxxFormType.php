...
namespace App\Features\Stores\Xxxx\Form;
 ...
 * Form type
 */
class XxxxFormType extends AbstractFormType
{
    use CaptchaAwareTrait;

    private XxxxFieldRegistry $fieldRegistry;
    ...
    public function __construct(
        XxxxFieldRegistry $fieldRegistry,
    ...
    {
        return 'xxxx_edit_form';
    }

    /** {@inheritdoc} */
    public function buildForm(FormBuilderInterface $builder, array $options = []): void
    {
        $actionType = 'xxxx_edit';
        ##############################################################################
