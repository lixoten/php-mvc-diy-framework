        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <?php if ($paginationData['previous']) : ?>
                    <li class="page-item">
                        <?= LinkHelper::render($paginationData['previous'], ['class' => 'page-link']) ?>
                    </li>
                <?php else : ?>
                ...
                <?php foreach ($paginationData['pages'] as $page) : ?>
                    <li class="page-item <?= $page['active'] ? 'active' : '' ?>">
                        ...
                        <?php else : ?>
                            <?= LinkHelper::render($page, ['class' => 'page-link']) ?>
                        <?php endif; ?>
                    </li>
                <?php endforeach; ?>
                ...
                <?php if ($paginationData['next']) : ?>
                    <li class="page-item">
                        <?= LinkHelper::render($paginationData['next'], ['class' => 'page-link']) ?>
                    </li>
                <?php else : ?>
                    <li class="page-item disabled">
        ...
        <nav aria-label="Windowed pagination">
            <ul class="pagination">
                ...
                <?php if ($windowedData['previous']) : ?>
                    <li class="page-item">
                        <?= LinkHelper::render($windowedData['previous'], ['class' => 'page-link']) ?>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($windowedData['next']) : ?>
                    <li class="page-item">
                        <?= LinkHelper::render($windowedData['next'], ['class' => 'page-link']) ?>
                    </li>
                <?php endif; ?>
            </ul>
        </nav>
